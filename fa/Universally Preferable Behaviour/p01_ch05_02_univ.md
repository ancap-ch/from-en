...
|                            | فیزیک                                                                                           | بیولوژی                                                                                      | اخلاق                                                                                                                      |
|:-------------------------- |:------------------------------------------------------------------------------------------------- |:-------------------------------------------------------------------------------------------- |:----------------------------------------------------------------------------------------------------------------------------- |
| **موضوع**                | مسئله                                                                                            | مسئله اصلی                                                                               | رفتار ترجیحی برای بشر                                                                                             |
| **نمونه**               | سنگ                                                                                           | اسب                                                                                      | مرد                                                                                                                         |
| **نمونه قانون**            | جاذبه زمین                                                                                           | میل به بقا                                                                      | مالکیت خود                                                                                                               |
| **نظریه نمونه**          | آنتروپی                                                                                           | سیر تکاملی
                                                                                    | حقوق مالکیت
                                                                                                               |
| **طبقه بندی نمونه**  | ماده / انرژی                                                                                     | خزنده/ پستاندار                                                                              | خوب / بد                                                                                                                    |
| **مثال**                | ماده نمی تواند ایجاد یا نابود شود، صرفا به انرژی و بازگشت تبدیل می شود                       | اگر این است زنده و گرم، آن یک پستاندار است                                           | سرقت اشتباه است                                                                                                           |
| **فرضیه
**             | اتم ها ساختارها و خواص مشترک دارند و بنابراین در رفتار های قابل پیش بینی و سازگار رفتار می کنند | ماده آلی دارای قوانین یا الزامات است که در همه طبقه بندی ها رایج است          | رفتار ترجیحی در جهان، قوانین و الزامات مشترک را در بر می گیرد                                                         |
| **اثبات**                  | سازگاری منطقی، تأیید تجربی                                                     | سازگاری منطقی، تأیید تجربی                                                  | Logical consistency, empirical verification                                                                                   |
| **مثال برای مثبت و منفی** | اگر جرم توده ای را جذب نکند، نظریه های وابسته به گرانش نادرست است                          | اگر موجودات به طور طبیعی خود را برای بقا انتخاب نکنند، نظریه تکامل نادرست است | اگر کمونیسم نسبت به اهداف اعلام شده خود موفق شود، نظریه های مبتنی بر اعتبار جهانی حقوق مالکیت نادرست است |
...
این چارچوب میتواند بعنوان یک چارچوب برای تصدیق نظریات یا گزاره های اخلاقی لحاظ گردند.درست مانند متد علمی که چارچوبی است که برای تصدیق گزاره ها یا نظریات علمی استفاده میگردند.
