...
<p>
  ...
  <p>
    Con la monopolización de la producción de leyes y seguridad, el tráfico, la comunicación y la educación, así como la democratización del gobierno estatal en sí, se han identificado todas las características del estado moderno, una sola: la monopolización estatal del dinero y la banca. For all but this one it has been explained, albeit briefly, how they can and must be understood as performing strategic functions: why and how they are not normal productive contributions determined by demand and supply forces or simply good deeds, but redistributive activities which serve the purpose of stabilizing and, if possible, increasing a state’s exploitatively appropriated income and wealth.
  </p>
