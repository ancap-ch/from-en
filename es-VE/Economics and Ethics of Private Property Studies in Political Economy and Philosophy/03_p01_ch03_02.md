...
<p>
  El tamaño y el crecimiento de una empresa productiva está restringido por un lado, por la demanda del consumidor voluntario, por el otro, por la competición de otros productores que obliga constantemente a cada firma a operar con los costos más bajos posibles, si desean permanecer en el negocio. Para que una empresa así crezca en tamaño, las demandas más urgentes del consumidor deben ser atendidas de las formas más eficientes. Nada salvo las compras del consumidor voluntario soportan su tamaño.
</p>

<p>
  Las restricciones sobre otro tipo de instituciones -El estado- son compretamente distintas. <fnref target="10" /> Por una parte, es obviamente absurdo decir que su emergencia y crecimiento se determina por la demanda en el mismo sentido que en una firma económica. Uno no puede decir ni con mucha imaginación que los cultivadores, los productores y los intercambiadores contractuales quienes deben rendir (una parte) de sus activos al estado, han pedido tal cosa. En su lugar, todos están cohercionados a aceptarlo, y esto es prueba clara del hecho de que este servicio no ha sido solicitado en lo absoluto. Por un lado, el estado tampoco está restringido en la misma forma, por competencia como lo estaría una firma productiva. Porque al contrario de semejante empresa, el estado no debe mantener sus costos operativos al mínimo, pero puede operar a costos por encima de los mínimos, porque es capaz de transferir sus costos más altos hacía sus competidores o imponiendo impuestos y regulando sus actividades. A medida que el estado surge, entonces, lo hace a pesar del hecho de que no sus servicios no son ni solicitados ni eficientes.
</p>
