...
Des terriers de cette narcissique de l'utérus de l'interprétation subjective nécessaire le travail des millénaires – et coûté la vie à des millions de personnes. L'effort requis pour la clé de notre point de vue à partir de *expérience perceptive* to *conceptuel logique* était terrifiant, exaltante, très déroutant et extrêmement dangereux. Comprendre que le monde n'était pas ce qu'il *sentais comme*, ou *semble*, a été – et demeure – le plus grand exploit de notre intelligence. The *truth* of reality turned out to be in the eyes of the mind, not of the flesh.
