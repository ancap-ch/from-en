...
Dopo questa ricostruzione del classico, e soprattutto della teoria austriaca dell'occupazione, del denaro, degli interessi e del processo capitalista, passerò ora a Keynes e alla sua "nuova" teoria. Di fronte al contesto della nostra spiegazione del vecchio, sarà facile riconoscere la "nuova" *Teoria Generale dell'Occupazione, dell'Interesse e del Denaro* di Keynes come fondamentalmente difettosa e la rivoluzione keynesiana come uno dei più importanti scandali intellettuali del XX secolo. [^23]

#### Occupazione

Keynes parte con una falsa teoria dell'occupazione. Contrariamente alla visione classica, afferma che può esserci disoccupazione involontaria sul libero mercato; e, inoltre, che un mercato può raggiungere un equilibrio stabile con la disoccupazione involontaria persistente. E nel pretendere che tali fallimenti del mercato siano possibili, egli sostiene di aver scoperto la logica economica ultima per interferire nelle operazioni dei mercati con forze extra-mercato.

Poiché il libero mercato è definito in termini di proprietà privata o prodotta e la volontarietà di tutte le interazioni tra possesori di proprietà private, dovrebbe essere chiaro che ciò che Keynes afferma di mostrare è approssimativamente equivalente all'operazione di rendere quadrato un cerchio.

Keynes inizia con la falsa affermazione secondo la quale la teoria classica assume "che non esiste una disoccupazione involontaria in senso stretto". [^24] In realtà, non assume nulla di simile. La teoria classica assumeva che la disoccupazione involontaria fosse logicamente-prasseologicamente impossibile fino a quando sarà operativo un libero mercato. Che la disoccupazione involontaria, anzi qualsiasi sua cifra, possa esistere in presenza di un'istituzione extra-mercato, di leggi sul salario minimo, ecc., non è mai stata seriamente messo in dubbio.

Dopo questa falsità, Keynes procede quindi a dare la sua definizione di disoccupazione involontaria:

> Gli uomini sono disoccupati involontariamente se, nel caso di un piccolo aumento del prezzo dei salari [vale a dire i beni di consumo] rispetto al salario monetario, sia l'offerta aggregata di lavoro disposta a lavorare per l'attuale salario monetario e la domanda aggregata a quella retribuzione sarebbe superiore al volume di occupazione esistente. [^25]
