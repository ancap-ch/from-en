...
> Ücret-mallarının [yani, tüketim malları] fiyatında para-ücrete göre küçük bir artış durumunda bile hem mevcut para-ücret için çalışmaya istekli olan toplam iş gücü arzı hem de bu ücrette onun için toplam talep istihdamın mevcut hacminden daha fazla olursa insanlar gönülsüz olarak işsizdir.[^25]
...
> istihdamın [ve sosyal gelirin] makul derecede ortalama seviyesine izin verecek olan faizin ortalama oranı olasılığı refah sahipleri için o kadar kabul edilemezdir ki, sadece para miktarını maniple ederek kolaylıkla tesis edilemez.[^57] 
...
[^23]: Keynes yanlısı literatür için özellikle bakınız Seymour P. Harris, diğerleri., *Yeni Ekonomi* (New York: Alfred Knopf, 1947); Alvin Hansen, *Keynes Rehberi* (New York: McGraw-Hill, 1953); Keynes karşıtı literatür için özellikle bakınız Henry Hazlitt, *"Yeni Ekonomi" nin Başarısızlığı* (Princeton, N.J.: D. Van Nostrand, 1959); aynı yazar, diğerleri., *Keynesyen İktisadın Eleştirileri* (Lanham, Md.: Amerika Üniversitesi Yayınları, 1983).

[^24]: Keynes, *Genel Teori*, s. 21; ayrıca ss. 6, 15.
...
[^26]: Ayrıca bakınız Hazlitt, "Yeni Ekonomi''nin Başarısızlığı s. 30.

[^27]: Keynes, *Genel Teori*, ss. 242-43; ayrıca s. 28.

[^28]: Hazlitt'in "Yeni Ekonominin" Başarısızlığı adlı çalışmasına da bakın. sayfa 52.

[^29]: Keynes, *Genel Teori*, s. 293.
...
[^34]: Fonksiyonel ilişkiler varsayımının -nedensel yerine- absürt etkileri üzerine aşağıdaki tartışmayı inceleyin.

[^35]: Keynes, *Genel Teori*, s. 174.

[^36]: Ibid., p. 167.

[^37]: Ayrıca bakınız Hazlitt, "Yeni Ekonomi" nin Başarısızlığı, ss. 188f.

[^38]: Ayrıca bakınız Rothbard, *Amerika'nın Büyük Buhranı*, ss. 40-41; Mises, *İnsan Eylemi*, ss. 521-23.

[^39]: Keynes, *The General Theory*, p. 296.

[^40]: Ayrıca bakınız W.H. Hutt, *İşe Yaramaz Kaynaklar Teorisi* (Indianapolis: Liberter Fon, 1977).

[^41]: Keynes, *Genel Teori*, s. 173; ayrıca merkantilist ekonomi, ve özellikle, Silvio Gesell hakkındaki övgü sözlerini 341, 355 numaralı sayfalarda bu görüşün öncülerinden görüyoruz.

[^42]: Buradan ayrıca bakınız Rothbard, *İnsan, Ekonomi ve Devlet*, ss. 687-89.
...
[^51]: Ayrıca bakınız Hazlitt, ''*Yeni Ekonominin*'' *Başarısızlığı*, ss. 231-35\. Keynes'in faiz oranını sıfıra indirgemek istediği parasal kredilerin genişlemesinin sadece bir kağıt fazlalığı olduğuna ve ancak gerçek tasarruf"la aşılabilecek kıtlık sorununun "gerçek" malların bir meselesi olduğuna açıkça itiraz edilmesine ne demeli? Bunun için onun *Genel Teori*'de aşağıdaki saçma cevabı vardır:
...
> Aynı mantıkla bir gecede istediğimiz kadar yeni "tasarruf" yaratabiliriz, yalnızca bu miktarda parayı basarak çünkü *biri* mutlaka bu kağıt parayı elinde tutacaktır! (*''Yeni Ekonomi'' nin Başarısızlığı*, s. 227)

[^52]: Bakınız Keynes, *Genel Teori*, ss. 129ff., 336ff., 348f. Keynes'in altın standardının fiilen tahrip edilmesindeki rolü bakınız Henry Hazlitt'e, *Bretton Woods'dan Dünya Enflasyonuna* (Chicago: Regnery, 1984).

[^53]: Keynes, *Genel Teori*, s. 161.
...
[^57]: Keynes, *Genel Teori*, ss. 308-09.

[^58]: Aynı eser., s. 309 ve dipnotta, "Bagehot tarafından aktarılan, John Bull'un birçok şey yapabileceğini, ancak yüzde 2'sinin dayanamayacağı 19. yüzyılda söyleniyor" diye ekliyor Keynes'in komplo teorisinde ayrıca bakınız Hazlitt, *"Yeni Ekonomi" nin Başarısızlığı*, ss. 3, 16-18.
