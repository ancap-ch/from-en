...
“Opinions” are those beliefs which have no clear evidence in reality, or for which no clear evidence can be provided, or which are expressions of merely personal preferences. My personal opinion is that I prefer chocolate ice cream to vanilla – I may also have an “opinion” that Iceland is a tropical paradise, or that God exists, or that rain falls upward. Kişisel görüşlerin açıkça ahlak ile hiçbir ilgisi yoktur; gerçekliği doğru bir şekilde tanımladığını iddia eden görüşler, ancak yanlış önyargılardır. Believing that the rain falls upward does not reverse its course; wearing a Hawaiian shirt to Iceland does not make Reykjavik any warmer.
...
ETD'ye göre, benim ve senin için çalmak yanlış. Ancak, "geçersiz bölge"de çalmak sadece kabul edilmekle kalmaz ayrıca tamamen *ahlaki* olarak da nitelenir. Biz *çalmamalıyız* - onlar *çalmalı*. Bu ahlaki delilik!
