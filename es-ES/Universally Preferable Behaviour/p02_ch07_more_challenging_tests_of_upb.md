## Pruebas más desafiantes de la CUP

Hasta ahora, se han probado teorías morales especificas relativas al esquema de CUP, y hemos llegado a la conclusión de que la CUP valida nuestras creencias morales más comunes, como la prohibición en contra de las violaciones, asesinatos y robos. Trayendo el criterio de *evitabilidad* a nuestro análisis, hemos también ayudado a diferenciar crímenes que no pueden ser evitados, y crímenes que son habilitados a través de acciones positivas, como el fraude. Finalmente, hemos dividido el "comportamiento preferible" en tres categorías mayores – universal, estética y neutral (y sus opuestos relevantes). En las acciones prohibidas universalmente se encuentran las violaciones, asesinatos y robos, las cuales pueden ser prevenidas con fuerza. En las acciones estéticamente preferibles, se incluyen la amabilidad, la puntualidad y ese tipo de cosas, las cuales no pueden ser forzadas a través de la violencia. Las acciones neutrales están definidas puramente por preferencias subjetivas, o acciones que no tienen contenido moral, como correr por un autobús.

En cualquier caso, aún quedan muchas pruebas morales que quedan fuera de los ejemplos que han sido mencionados anteriormente. Trataremos solo con pocos de esos aquí, para examinar el esquema de CUP, y ver como se manejan estas preguntas morales que son más desafiantes.
...
Si fuera universalmente preferible usar la fuerza, entonces ningún ser humano podría usar un argumento moral, pero debería preferir usar la fuerza para alcanzar sus metas. Sin embargo, así como en los ejemplos de violación, robo y asesinato citados anteriormente, la afirmación de que es universalmente preferible usar la fuerza, se invalida a sí misma. Para poder usar la fuerza sobre otra persona, se requiere que la otra persona se someta a la fuerza – en otras palabras, para que una persona sea moral, la otra debe ser inmoral, lo que no puede pasar. También, si la otra persona *se somete* a la fuerza, no es fuerza – por lo tanto, debe *resistir*, lo cual requiere que resista la virtud para poder usar la virtud, lo que es contradictorio.
...
Además, si los seres humanos no pueden actuar con validez para prevenir que se hagan daño a sí mismos, entonces las acciones tales como vacunarse, usar guantes cuando hace frio, usar protector solar o repelente de insectos, construir un muro para prevenir un derrumbe, cepillarse los dientes, usar zapatos y otras más, son acciones inmorales. Si volvemos a Bob y Doug, y les damos el argumento moral de que la autodefensa está siempre mal, ¿que resultaría?

Bueno, hemos creado otra paradoja. La autodefensa es el uso de la violencia para prevenir la violencia. Si la autodefensa es siempre incorrecta, entonces no puede ser violentamente "infligida" a un atacante. Sin embargo, las preferencias que no pueden ser infligidas a otros entran dentro de APA o la categoría moralmente neutral. El asignar la violencia o autodefensa a una de estas categorías es decir que la violencia no puede ser infligida a otros - pero la naturaleza propia de la violencia es que esta *es* infligida a otros, de manera que esta aproximación resulta en un exceso de contradicciones.

La autodefensa no puede ser "malvada", ya que lo malvado, por definición, puede ser prevenido con la fuerza. Sin embargo, la autodefensa es una respuesta a la iniciación de la fuerza, y, de esta forma, no puede ser prevenida a con fuerza, más de lo que se puede prevenir el movimiento de una pelota de futbol pateándola violentamente.
...
Esta es una objeción interesante – sin embargo, si la iniciación de la fuerza es mala, entonces puede ser prohibida usando la fuerza, ya que esa es una de las definiciones del mal que hicimos anteriormente.

Así, es imposible para cualquier teoría lógica moral el rechazar la validez moral de la autodefensa.

### Crianza de Niños

Instintivamente, generalmente entendemos que hay algo que está muy mal con los padres que no alimentan a sus bebes. Concebir un niño, llevarlo en el vientre durante 9 meses, dar a luz al niño, y luego dejarlo en su cuna para que muera de hambre, ofende severamente nuestras sensibilidades.
...
Así, cuando señalamos situaciones de responsabilidad reducida, no estamos *quitando* responsabilidades que existen, pero si estamos reconociendo una situación donde la responsabilidad no existe, por lo menos en hasta cierto punto. Si yo digo que un hombre en una silla de ruedas no puede usar las escaleras mecánicas, no estoy quitándole sus derechos de usar la escalera mecánica, solo estoy señalando que no puede usarla. Cuando digo que la CUP no aplica a las acciones de un niño de cinco años, no digo que la CUP sea más subjetiva de lo que el requerimiento de altura de una montaña rusa hace que de alguna manera el concepto de "altura" sea subjetivo.

Si voluntariamente firmo un contrato en el cual prometo pagar tus deudas por un año, no he firmado para convertirme en tu esclavo, pero ciertamente he asumido una obligación positiva de la cual ahora soy responsable.

Si manejo un asilo, y acepto pacientes que no pueden alimentarse a sí mismos, y no los alimento, soy responsable por sus eventuales muertes. Nadie está *forzándome* a aceptar esos pacientes, pero una vez que he expresado el deseo y la voluntad de cuidar de ellos, entonces soy responsable por su continuo bienestar.

De la misma forma, si tomo prestada tu podadora, estoy obligado a devolverla en por lo menos el mismo estado que estaba cuando la tomé prestada. Similarmente, si voy a una tienda de mascotas y compro un perro, he tomado la obligación voluntaria de cuidar ese perro. Esto no quiere decir que soy el esclavo del perro hasta que muera, pero si quiere decir que mientras el perro esté en mi posesión, tengo la responsabilidad de intentar mantenerlo sano.

Este tipo de contratos implícitos son muy comunes en la vida. Nunca firmamos un contrato con el dueño de un restaurante cuando vamos a comer en su restaurante; simplemente está acordado que pagaremos antes de irnos. Nunca he firmado un contrato cuando entro a una tienda en el cual prometo no robar, pero ellos tienen el derecho de procesarme si lo hago. Igualmente nunca he firmado un contrato en el cual prometo no violar a una mujer si tenemos una cita, sin embargo ese "contrato" ciertamente existe, de acuerdo a UPB.

Si manejo un asilo, y las personas discapacitadas dependen de mí para alimentarlos, si pruebo que soy incapaz de hacerlo por alguna razón, entonces mi responsabilidad es, claramente, buscar a alguien más que pueda alimentarlos. El grave peligro no es que *Yo* no los alimente, sino que todo el mundo crea que yo los *estoy* alimentando, y que entonces no lo haga realmente. Esto coincide con una vieja discusión moral acerca de sumergirme en un rio a salvar a alguien que está ahogándose. No estoy obligado a saltar al rio a salvar a alguien que está ahogándose, pero en el momento en el que lo hago –o declaro mi intención de hacerlo– me vuelvo responsable de intentar salvar a esa persona, por la misma razón por la que todo el mundo piensa que voy a salvar a esa persona, y por la cual ellos no tomarán acción directa. 

Así, se asume que los padres de un bebe recién nacido deben alimentarlo. Si dichos padres deciden no cuidar al bebé, entonces estarán obligados a dar al bebe en adopción a personas que si lo *cuidarán*, o enfrentar los cargos de homicidio, de igual forma que el gerente de un asilo debe alimentar a quienes dependan de él, o conseguir a alguien quien vaya a hacerlo. Si decido que no cuidaré más a mi perro, debo buscarle otro hogar, no simplemente dejarlo morir de hambre.

Todo esto se basa en el principio de la autodefensa de terceros, el cual está totalmente apoyado por el esquema de CUP, ya que el derecho de la autodefensa es universal. Si veo un hombre en una silla de ruedas siendo atacado por una mujer, tengo el derecho de defenderlo – y todo esto es mucho más cierto si el carece de capacidades para defenderse.

Ya que los niños no pueden alimentarse a sí mismos, trabajar o vivir independientemente, son equivalentes a las víctimas de secuestros, o la esposa de la que hablamos antes cuyo esposo la encierra en el sótano. Los niños también carecen de la capacidad para autodefenderse efectivamente, debido a su pequeña estatura y la dependencia casi completa de sus padres.

Por lo tanto, ya que ciertamente tenemos el derecho de actuar en defensa de alguien más – y ese derecho se vuelve mucho más fuerte si esa persona no puede actuar en su propia defensa, es perfectamente válido usar la fuerza contra padres que no alimentan a sus hijos, de igual manera que es perfectamente válido el uso de la fuerza contra el esposo que mata de hambre a su esposa encerrándola en el sótano.

Como mencionamos más arriba, mientras una víctima sea menos capaz de evitar la situación, peor es el crimen. Incluso si la esposa que termina encerrada en el sótano tiene por lo menos *algo* de culpa en el asunto, ya que escogió casarse con este lunático malvado en primera instancia. Una vez que está encerrada en el sótano, la situación es inevitable, sin embargo, no cabe duda de que ella recibió muchas pistas de la naturaleza abusiva de su esposo, desde el día en el que lo conoció.

Los niños, sin embargo, son las mayores víctimas, porque ellos nunca tuvieron la oportunidad de evitar las situaciones en las que puedan encontrarse. Así, podemos establecer lógicamente la responsabilidad de los padres con sus hijos usando el esquema de UPB. Ya que toda persona es responsable de los efectos de su cuerpo, y los niños son un efecto del cuerpo, entonces los padres son responsables de los niños. Como todos tenemos el derecho de la autodefensa, para nosotros mismos y para otros – porque es un derecho universal – entonces todos podemos actuar para defender a los niños. Ya que todo el mundo debe cumplir con obligaciones voluntarias, y tener hijos es una obligación voluntaria, los padres deben cumplir estas obligaciones relacionadas con los niños. Ya que, no actuar, causando la muerte de alguien que depende de ti es equivalente a asesinarlo, los padres pueden ser responsables de dicho crimen.
