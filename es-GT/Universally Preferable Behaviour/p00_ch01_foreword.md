...
2. La ética no puede ser objetivamente definida como "lo que es bueno para la supervivencia del hombre". Ciertos individuos pueden sobrevivir muy bien si se aprovechan de otros, así que esta definición de ética no supera el problema del subjetivismo. En términos biológicos, esto sería análogo a describir las tendencias evolutivas como "aquello que es bueno para la supervivencia *de la vida* – esto no tendría sentido. La sociedad humana es un ecosistema de intereses que compiten, y tal como lo es la selva, lo que es "bueno" para un hombre a menudo viene a expensas de otro.
