...
Como se mencionó anteriormente, la primera prueba de cualquier teoría científica es *universalidad*. Así como una teoría de la física debe aplicarse a * todas las * materias, una teoría moral que dice describir las acciones preferibles de la humanidad * debe aplicarse a ** toda **la humanidad *. Ninguna teoría moral puede ser válida si argumenta que una determinada acción es *correcta* en Siria, pero *incorrecta* en San Francisco. No se puede decir que la Persona A *debe* hacer X, pero la persona B debe *nunca* debe hacer X. No se puede decir que lo que era *inadecuado* ayer es *derecho* hoy, o viceversa. Si lo hace, es falso y debe refinarse o descartarse.
...
Sin embargo, dado que las teorías morales se aplican a la humanidad y la humanidad es orgánica, el grado de coherencia * empírico* requerido para las teorías morales es menor que el requerido para las teorías * inorgánicas *. Todas las rocas, por ejemplo, deben caerse, pero no todos los caballos deben nacer con una sola cabeza. La biología incluye tres formas de "aleatoriedad", que son el medio ambiente, la mutación genética y el libre albedrío. Por ejemplo, los caniches generalmente son amigables, pero si se golpean durante años, es probable que se vuelvan agresivos. Los caballos se definen como teniendo solo una cabeza, pero ocasionalmente nace un mutante de dos cabezas. Del mismo modo, los seres humanos generalmente prefieren comer a los hambrientos, excepto los anoréxicos. Estas excepciones no reducen toda la ciencia de la biología. Por lo tanto, como las teorías morales describen a la humanidad, no pueden someterse exactamente a los mismos requisitos de consistencia que las teorías que describen la materia inorgánica.
