...
Esto no es solamente un rango de contradicción en términos de sintaxis, sino que también inmediatamente falla la prueba del CUP. Si yo prefiero el Jazz a los otros tipos de música, pero tú prefieres la música clásica a los otros tipos de música, si las preferencias personales son universalmente preferible, entonces tú deberías preferir el jazz porque a yo lo hago, y yo debería preferir la música clásica porque tú lo haces. Esto, por supuesto, es imposible, porque eso requeriría que ambos *simultáneamente* prefiriéramos tanto el jazz como la música clásica sobre todas las demás formas de música. Tu deberías cambiar tu preferencia a jazz a causa de mi preferencia - pero yo debería a la vez cambiar mi preferencia a clásica a causa de tu preferencia. Esto es como decir que tu debería tanto lanzan como atrapar la misma pelota de béisbol exactamente al mismo tiempo - una imposibilidad lógica y física.
