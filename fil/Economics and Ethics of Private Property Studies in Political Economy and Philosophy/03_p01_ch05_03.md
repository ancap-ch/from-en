...
Ang parehong konklusyon ay naaabot kung ang mga pagbabago sa supply ng pera (binibigyan ang kagustuhan ng pagkatubig) ay isinasaalang-alang. Sinabi ni keynes na ang pagtaas sa suplay ng pera, ang iba pang mga bagay na pantay, ay maaaring magkaroon ng positibong epekto sa pagtatrabaho. He writes, “so long as there is unemployment, employment will change in the same proportion as the quantity of money.”[^39] Yet this is not only a highly curious pronouncement because it *assumes* the existence of unemployed resources instead of *explaining* why such a thing should possibly occur—for, obviously, a resource can be unemployed only because it is either not recognized as scarce at all and thus has no value whatsoever, or because its owner voluntarily prices it out of the market and its unemployment then is no problem that would call for a solution.[^40]
