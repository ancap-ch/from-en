...
Sa katulad na paraan, ang dalawang lalaki sa loob ng isang kwarto ay dapat isaalang-alang para maging isang sitwasyon. If only one of them can be good, because goodness is defined as rape, and only one of them can rape at any time, then we have a logical contradiction that cannot be resolved.
