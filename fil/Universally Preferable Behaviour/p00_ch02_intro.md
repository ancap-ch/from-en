...
Sa kabaligtaran, sa "sona ng kawalan" ng relihiyon, ang *eksaktong kabaligtaran* ng kapwa maliit na mga katotohanan at mga dakilang katotohanan ay pinaniniwalaang totoo. Personally, a man believes that *that which cannot be perceived does not exist* – intellectually, science has proven this repeatedly. However, in the “null zone” of theology, the exact opposite proposition holds true – the axiom there is *that which cannot be perceived **must** exist*.
