...
即使有人放弃这种批评，这个声明仍然是错误的。 因为如果其他的东西确实是平等的，那么额外的货币供给就会导致总体价格的上涨，工资率的同步增长和比例上升，而且根本不会有什么变化。 如果与此相反，就业应该增加，这只有在工资率不与其他价格同时上涨的情况下才可能实现。 然而，其他的东西不能再被说成是平等的，因为实际的工资率会下降，而就业只有在实际工资下降的情况下才会上升，如果假定就业对自雇就业（即失业）的相对评估改变。 但如果这是假设的话，就不需要增加货币供应量。 同样的结果（就业增加）也可能由接受较低名义工资率的劳动力所带来。
