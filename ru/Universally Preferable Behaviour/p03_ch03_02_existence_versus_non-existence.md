...
Однако правительство* само * не подлежит какой-либо силе или возмездию, но является законом для себя. Даже в западных демократиях, сколько полицейских и политиков попадают в тюрьму?
