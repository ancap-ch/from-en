...
Como mencionado acima, o método científico é essencialmente uma metodologia para separação precisas de teorias imprecisas sujeitando-os para dois testes centrais: consistência lógica e observação empírica - e sempre subjugando consistência lógica à observação empírica. If I propose a perfectly consistent and logical theory that says that a rock will float *up* when thrown off a cliff, any empirical test proves my theory incorrect, since observation always trumps hypothesis.
