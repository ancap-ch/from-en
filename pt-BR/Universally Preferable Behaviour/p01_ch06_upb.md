...
Existem poucos motivos para escrever um livro sobre preferências pessoais - e nós podemos nos voltar para Ann Landers para uma discussão sobre comportamentos socialmente preferíveis - aqui, então, focaremos na possibilidade de *Comportamentos Universalmente Preferíveis*.
...
Se, no entanto, quando eu decidi deixar seu jantar, você salta e me acorrenta na cadeira, claramente eu não tenho mais a liberdade de escolha de sair. Esse é o momento em que sua rudeza se torna uma evidente agressão, e cruza a linha de estética para ética.
...
A questão da *evasão* é a chave para diferenciar estética de ética. Estética se aplica a situações que podem ser desagradáveis, mas não elimina sua capacidade de escolha.

#### Evasão e Iniciação

Tem um problema particular com evasão que vai vir mais tarde neste livro, que vale a pena esclarecer aqui, de antemão.

Se eu moro no topo de uma montanha bem alta à cinco mil quilômetros de distância de você, e eu te mando um e-mail falando que se você andar na frente da minha casa, eu vou atirar em você, é relativamente fácil para você evitar essa situação. Meu uso da força é certamente imoral, mas questões seriam certamente levantadas se vi e imediatamente entrasse em um avião, escalasse minha montanha e lentamente andasse na frente da minha casa.
...
De maneira similar, se um representante de crimes organizados vir para a minha casa e ameaçar queimá-la se eu não pagar um dinheiro regular para proteção, eu posso evitar essa ameaça específica me mudando para outro continente, mas isso iria parecer só uma maneira injusta de tratar a situação, já que eu tenho agora que iniciar uma ação para evitar a ameaça.
...
Claramente, essa questão da evasão é central para nossa avaliação moral de causa e efeito. Doenças que te atacam sem aviso, e que não podem ser prevenidas, assustam-nos bem mais do que aquelas que podem ser evitadas. Nós podemos minimizar as chances de contrair câncer de pulmão por abster-se de fumar, assim como podemos ajudar a prevenir o câncer de pele usando filtro solar, e evitar quebrar ossos abstendo-se de esportes radicais. Do mesmo modo, nós podemos fazer muito para evitar crimes através de alguns hábitos simples, assim como escolher companheiros morais, evitando locais e situações onde crimes são mais prováveis, abstendo-se de uso de substâncias e assim por diante.

Há um fenómeno conhecido como "morto pela polícia," no qual pessoas suicidas provocam uma briga com a polícia, e fingem sacar uma arma para levar um tiro. Esse é um exemplo extremo de perseguir situações onde a "vitimização" é quase garantida. Isso também pode ocorrer em situações domésticas, onde uma mulher verbalmente atacará um marido bêbado, sabendo perfeitamente bem que o álcool inflama seu temperamento violento. Nessas situações, nós podemos sentir alguma simpatia pelo homem cujo teve sua certeira roubada no parque, ou pela mulher que foi atacada na festa de fraternidade, ou pela mulher que apanhou do marido - mas ao mesmo tempo, nós teríamos algumas questões significativas em relação à sua função ou cumplicidade nos erros que eles sofreram. Para ser justo, nós temos que diferenciar entre um homem cuja carteira foi roubada à mão armada, e um homem que deixa sua carteira deitada sobre um lugar público. Ambos os homens tiveram suas carteiras roubadas, para ser exato, porém dificilmente pareceria razoável responsabilizá-los igualmente.
