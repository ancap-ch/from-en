...
Para ser válida, qualquer teoria moral também precisa transmitir o critério da "consistência lógica". Desde que o comportamento da matéria é lógico, consistente e previsível, todas as teorias envolvendo matéria - orgânica ou inorgânica - também precisam ser lógicas, consistentes e previsíveis. The theory of relativity cannot argue that the speed of light is both constant and not constant at the same time, or that it is one hundred eighty-six thousand kilometres per second, five kilometres in depth, and also green in colour.
