...
Conforme nossa definição de "saúde" expande, definições antigas não são invalidadas, mas sim estendidas. If medical technology advances to allow ninety-year-olds to win marathons, then our definition of what is healthy for the aged will change – but that does not mean that the twenty-year-old marathon runner suddenly becomes unhealthy. Learning algebra does not invalidate arithmetic.
