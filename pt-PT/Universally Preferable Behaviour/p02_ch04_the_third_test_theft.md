...
O que isso significa é que um homem é responsável pelas acções do seu corpo e, portanto, responsável pelos *efeitos* das mesmas. Um homem é responsável por onde coloca o seu pénis, que é como sabemos que o podemos julgar por violar alguém. É "dono" das acções do seu corpo, assim como é, com certeza, o dono do seu próprio corpo. To say that a man is responsible for his body but not the effects of his body is to argue that a man is responsible for aiming and throwing a knife, but not for where it lands.
