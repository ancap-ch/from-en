...
Além disso, se os seres humanos não podem agir de forma válida para evitar danos a si próprios, então acções como vacinar, usar luvas no frio, colocar protector solar ou repelente de insectos, construir uma parede para evitar um deslizamento de terra, escovar os dentes, usar sapatos e assim por diante, são acções imorais. If we return to Bob and Doug, and we give them the moral argument that self-defence is always wrong, what results?
