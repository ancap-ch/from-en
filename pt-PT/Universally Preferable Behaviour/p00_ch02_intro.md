...
A religião também é outra "meia verdade" - uma das mais perigosas. É verdade que somos uma espécie única no universo, tanto quanto sabemos. A girafa é o quadrúpede mais alto, mas o homem não é apenas um primata "mais inteligente", senão algo completamente diferente. The nature of that difference remains largely unknown – the religious explanation of “we are not the same as animals because we have a soul and were created by a God” is just another example of a “middle truth.” It is true that we are very different from animals. It is not true that we were created by a god and have a soul.
