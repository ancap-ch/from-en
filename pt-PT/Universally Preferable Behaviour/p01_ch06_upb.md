...
É essa capacidade de *evitar* situações, que forma a raiz central dos julgamentos éticos. Uma mulher violada por um intruso qualquer na sua própria casa é, sem dúvida, uma completa vítima de um crime terrível. Uma mulher que é violada depois de ficar cega de bêbada numa festa de fraternidade e a dançar nua numa mesa, é um caso mais complicado. Evidentemente, a violação, uma vez em curso, não pode ser evitada, já que está a ser violentamente infligida - no entanto, as situações que aumentam a probabilidade de violação podem ser evitadas.

Se alguém entra na minha casa com uma arma e leva a minha carteira, tenho todo o direito de me indignar. No entanto, se deixar a minha carteira num banco do parque durante uma semana, será que tenho o mesmo direito de me indignar quando descobrir que a perdi? Instintivamente, sentimos que isso parece ser menos justificável.

Claramente, esta questão de evasão é fundamental para a nossa avaliação moral de causa e efeito. As doenças que atacam sem avisar e que não podem ser evitadas, assustam-nos muito mais do que aquelas que podem ser evitadas. Podemos minimizar as possibilidades de contrair cancro de pulmão, evitando fumar, assim como podemos ajudar a prevenir o cancro da pele ao usar protector solar e evitar fracturas ósseas abstendo-se de desportos radicais. Da mesma forma, podemos fazer muito para evitar o crime através de hábitos bastante simples, como: a escolha de companheiros morais, evitar locais e situações em que o crime é mais provável, abster-se do abuso de substâncias e assim por diante.

Há um fenómeno conhecido como "morte pela polícia", em que as pessoas suicidas provocam uma briga com a polícia, e fingem buscar uma arma para levarem um tiro. Este é um exemplo extremo de perseguir situações em que a "vitimização" é quase garantida. Isso também pode ocorrer em situações domésticas, onde uma mulher atacará verbalmente um marido bêbado, sabendo perfeitamente que o álcool inflama o seu temperamento violento. Nestas situações, podemos ter alguma simpatia pelo homem cuja carteira é roubada no parque, ou a mulher que é atacada na festa de Fraternidade, ou a esposa que é espancada pelo marido, mas, ao mesmo tempo, teríamos algumas questões consideráveis sobre a sua forma de agir, ou cumplicidade nos erros que sofreram. Para sermos justos, devemos diferenciar entre um homem cuja carteira é roubada à mão armada e um homem que deixa a sua carteira num banco público. Os dois homens tiveram as suas carteiras roubadas, certamente, mas dificilmente pareceria razoável responsabilizá-los por igual.
