...
Como já discutimos anteriormente, entrar em qualquer debate requer uma aceitação das realidades de escolha, valores e responsabilidade pessoal. However, these factors are also present in the choice of the colour of paint for a room, yet we would scarcely say that selecting a hue is a *moral* choice. Thus there must be other criteria which must be present in order for a choice or proposition to be moral.
