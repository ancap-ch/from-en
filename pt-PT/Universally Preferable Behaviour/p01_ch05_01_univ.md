...
Tal como foi mencionado anteriormente, o método científico é essencialmente uma metodologia para separar teorias precisas de teorias imprecisas, submetendo-as a dois testes centrais: consistência lógica e observação empírica - e sempre submetendo a coerência lógica à observação empírica. If I propose a perfectly consistent and logical theory that says that a rock will float *up* when thrown off a cliff, any empirical test proves my theory incorrect, since observation always trumps hypothesis.
