...
Jadi, jika mencuri itu baik, maka kebaikan menjadi keadaan yang bisa dicapai hanya pada saat Doug mencuri pemantik Bob. In that instant, only Doug can be moral, and Bob cannot be. After that, goodness becomes impossible to achieve for either party, unless Doug keeps giving Bob’s lighter back and then snatching it away again.
