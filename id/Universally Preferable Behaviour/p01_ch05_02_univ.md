...
Seperti disebutkan di atas, tes pertama dari setiap teori ilmiah adalah *universalitas*. Just as a theory of physics must apply to *all* matter, a moral theory that claims to describe the preferable actions of mankind *must apply to **all** mankind*. Tidak ada teori moral yang bisa berlaku jika berpendapat bahwa tindakan tertentu benar *benar* di Syria, tetapi *salah* di San Francisco. It cannot say that Person A *must* do X, but Person B must *never* do X. It cannot say that what was *wrong* yesterday is *right* today – or vice versa. Jika ya, itu salah dan harus disempurnakan atau dibuang.
