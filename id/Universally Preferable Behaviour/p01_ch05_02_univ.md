...
Bagaimana semua ini terlihat dalam praktik? Let’s look at how the requirement for *universality* affects moral theories. Kita akan menyentuh di sini tentang bukti dan disproof untuk proposisi moral tertentu, yang akan kita bahas lebih rinci di Bagian Dua.

If I say that gravity affects matter, it must affect *all* matter. Jika bahkan satu kerikil terbukti kebal terhadap gravitasi, teori saya dalam masalah. If I propose a moral theory that argues that people should not murder, it must be applicable to *all* people. Jika orang-orang tertentu (seperti tentara) dibebaskan dari peraturan itu, maka saya harus membuktikan bahwa tentara tidak *bukan* orang, atau menerima bahwa teori moral saya salah. Tidak ada kemungkinan lain. On the other hand, if I propose a moral theory that argues that all people *should* murder, then I have saved certain soldiers, but condemned to evil all those *not* currently murdering someone (including those being murdered!) – which is surely incorrect.
